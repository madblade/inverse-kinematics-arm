...
IKSolver.prototype.solve = function(
    solver, chain, target, iterations, constraints
)
{
    switch (solver)
    {
        case Solver.CCD:
            this.ccdSolver.solve(chain, target, iterations, constraints);
            break;
        case Solver.FABRIK:
            this.fabrikSolver.solve(chain, target, iterations, constraints);
    }
};
